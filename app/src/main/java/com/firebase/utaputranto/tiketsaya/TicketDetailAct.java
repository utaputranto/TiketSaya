...
public class TicketDetailAct extends AppCompatActivity {
    ...
    TextView title_ticket,location_ticket,
            ...
            festival_ticket,short_dect_ticket;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        short_dect_ticket = findViewById(R.id.short_dect_ticket);
        ...
        //mengambil data dari firebase berdasarkan inten
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                short_dect_ticket.setText(dataSnapshot.child("short_desc").getValue().toString());
